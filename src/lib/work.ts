  ...
  },
  {
    ...
    caseStudy: {
      ...
      gallery: [
        ...
        { src: "/work/construction/daily-logs.jpg", label: "Daily logs" },
        { src: "/work/construction/meeting-minutes.jpg", label: "Meeting minutes" },
        { src: "/work/construction/deficiency-list.jpg", label: "Deficiency list" },
      ],
